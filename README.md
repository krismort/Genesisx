![Example-Logo](https://i.imgur.com/eS3G1dr.png)
# Genesisx Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Genesisx Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/y83VN9j)
***
## Requirements
1) **5,000 Genesisx coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Genesisx/master/genesisx_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash genesisx_install.sh`
...
***Step 1***
* Download and install the Genesisx wallet [here](https://github.com/genesis-x/genesis-x/releases)
***

***Step 2***
* Send EXACLY 5,000 XGS coins to a receive address within your wallet.
***
...
![Example-console](https://i.imgur.com/2nOEEa5.png)
***
...
![Example-outputs](https://i.imgur.com/sLSJr4E.png)
***
...
![Example-create](https://i.imgur.com/qiqB6LQ.png)
***
...
`genesisx-cli masternode status`

`genesisx-cli getinfo`
